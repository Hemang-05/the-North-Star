  ...
  return {
    ...
    time: {
      ...
      pillars: [
        {
          pillarId: 'job_hunt',
          pillarName: 'Career & Job Hunt',
          minutes: 600,
          hours: 10,
          sharePercent: 27.4,
          sessionCount: 6,
          changePercent: 0,
          topCategories: { Applications: 450 },
        },
        {
          pillarId: 'agency',
          pillarName: 'Software Agency',
          minutes: 720,
          hours: 12,
          sharePercent: 32.9,
          sessionCount: 8,
          changePercent: 5.2,
          topCategories: { ClientWork: 600 },
        },
        {
          pillarId: 'trading_os',
          pillarName: 'Trading OS & SaaS',
          minutes: 480,
          hours: 8,
          sharePercent: 21.9,
          sessionCount: 4,
          changePercent: -2.1,
          topCategories: { Development: 360 },
        },
        {
          pillarId: 'fitness',
          pillarName: 'Physical Fitness',
          minutes: 390,
          hours: 6.5,
          sharePercent: 17.8,
          sessionCount: 4,
          changePercent: 1.5,
          topCategories: { Workout: 240 },
        },
      ],
    },
    intelligence: {
